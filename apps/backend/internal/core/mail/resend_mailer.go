...
// onboarding@resend.dev คือ from address ของ Resend Sandbox Mode
// ใช้ได้เฉพาะตอนบัญชียังไม่ได้ verify โดเมนของตัวเอง — ถ้าจะเปลี่ยนไปใช้โดเมนจริง
// ต้อง verify DNS (SPF/DKIM) กับ Resend ก่อน แล้วค่อยเปลี่ยนค่านี้
