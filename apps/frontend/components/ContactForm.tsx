    ...
    <form onSubmit={handleSubmit} className="flex w-full flex-col gap-3">
      ...
      <label className="flex flex-col gap-1.5 text-sm">
        ...
        <textarea
          ...
          className="rounded-lg border border-[var(--border)] bg-[var(--bg-elev)] px-3 py-2 text-[15px] outline-none focus:border-[var(--accent)]"
        />
        {fieldError.message && <span className="text-xs text-red-500">{fieldError.message}</span>}
      </label>
      ...
      <div className="flex flex-col gap-1.5 text-sm">
        ...
        <input
          ...
          className="rounded-lg border border-[var(--border)] bg-[var(--bg-elev)] px-3 py-2 text-[15px] outline-none focus:border-[var(--accent)]"
        />
        {fieldError.contact && <span className="text-xs text-red-500">{fieldError.contact}</span>}
      </div>
